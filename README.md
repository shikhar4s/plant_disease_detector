...
- Open-Meteo city search and user-triggered geolocation with current conditions and a seven-day forecast; an attributed MET Norway forecast is used if Open-Meteo throttles the forecast request.
