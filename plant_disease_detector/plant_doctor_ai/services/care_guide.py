...
LANGUAGES = {
    'en': {
        ...
        'uncertain': 'The model is uncertain. Retake a sharp photo of one leaf in daylight with a plain background and check the supported plants.',
    ...
    'hi': {
        ...
        'uncertain': 'मॉडल निश्चित नहीं है। दिन की रोशनी में सादे बैकग्राउंड पर एक पत्ती की साफ फोटो लें और समर्थित पौधों की सूची देखें।',
    ...
    'es': {
        ...
        'uncertain': 'El modelo no está seguro. Tome una foto nítida de una hoja con luz natural y fondo sencillo; consulte las plantas compatibles.',
    ...
    'fr': {
        ...
        'uncertain': 'Le modèle est incertain. Reprenez une photo nette d’une feuille à la lumière naturelle sur fond simple et vérifiez les plantes prises en charge.',
